    ...
    cc.Class({
        ...
        initEventHandlers: function() {
            ...
            function(t) {
                ...
                t.userid == cc.vv.userMgr.userId && (e.loadHandcardNode(), e.ResetView())
            }),
            this.node.on("game_begin",
            function(t) {
                e.loadSeatsCardNode(!1)
            }),
            this.node.on("game_sync",
            function(t) {
                null != e.pokerprefab && void 0 != e.pokerprefab || e.loadHandcardNode(),
                0 == e.seatscard.length ? e.loadSeatsCardNode(!0) : cc.vv.gameNetMgr._HaveloadCards = !0
            }),
            ...
            function(t) {
                0 != cc.vv.gameNetMgr._HaveloadCards && (console.log("gameseat outcard-----"), e.usersPeiPai(t))
            }),
            this.node.on("compare_result",
            function(t) {
                0 != cc.vv.gameNetMgr._HaveloadCards && (console.log("gameseat compare_result-----"), e.setResultData(t))
            })
        },
        ...
        loadCardNode: function() {
            // return null != this.cardnode ? this.cardnode: (cc.loader.loadRes("prefabs/game/sss/card", cc.Prefab,
            // function(e, t) {
            //     if (e) cc.error(e);
            ...
            //         for (var a = 0; a < 6; a++) {
            //             var n = "seat" + a;
            //             this.cardnode.getChildByName(n).active = !1
            //         }
        ...
        getrealplayers: function() {
            for (var e = 0,
            t = cc.vv.gameNetMgr.seats,
            a = 0; a < t.length; a++) 0 != t[a].userid && e++;
            return e
        },
        loadSeatsCardNode: function(e) {
            return console.log(" load  SeatsCard ################################"),
            this.prefabseatcard ? (console.log("inituserseatcard ---1"), this.inituserseatcard(), this.loadCompareCard(), 0 == e && (console.log("1 -- -ResetView"), this.ResetView()), void(cc.vv.gameNetMgr._HaveloadCards = !0)) : (cc.loader.loadRes("prefabs/game/sss/seatcard", cc.Prefab,
            function(e, t) {
                e ? cc.error(e) : (this.prefabseatcard = t, console.log("inituserseatcard ---2"), this.inituserseatcard(), this.loadCompareCard(), this.loadGunNode(), this.ResetView(), console.log("2 -- -ResetView"), cc.vv.gameNetMgr._HaveloadCards = !0, console.log(" load  SeatsCard ===1 ################################"))
            }.bind(this)), null)
        },
        ...
        inituserseatcard: function() {
            ...
            var e = this.getrealplayers(),
            t = cc.vv.gameNetMgr.getLocalSeats();
            if (this.seatscard = [], this.prefabseatcard) for (var a = 0; a < e; a++) {
                var n = cc.instantiate(this.prefabseatcard),
                i = "seat" + t[a],
                s = this.cardnode.getChildByName(i);
                s.active = !1;
                var o = s.getChildByName("seatcard");
                null != o && void 0 != o || s.addChild(n),
                this.seatscard.push(s)
            }
        },
        drawBackCard: function(e) {
            e.getChildByName("xiaowang").active = !1,
            e.getChildByName("dawang").active = !1,
            e.getChildByName("val").active = !1,
            e.getChildByName("color").active = !1,
            e.getChildByName("shadow").active = !1;
        ...
        drawCard: function(e, t) {
            ...
            cc.vv.gameNetMgr.drawCard(e, t)
        },
        drawCardSprite: function(e, t) {
            cc.vv.gameNetMgr._cardRes[t] && (e.spriteFrame = cc.vv.gameNetMgr._cardRes[t])
        },
        ResetView: function() {
        ...
        resetALLSeat: function() {
            for (var e = cc.vv.gameNetMgr.seats,
            t = 0; t < e.length; t++) if (e[t].userid <= 0) {
                var a = cc.vv.gameNetMgr.getLocalIndex(e[t].seatindex);
                this.seatComs[a].setInfo(e[t]),
                this.seatComs[n].setReady(!1)
            } else {
                var n = cc.vv.gameNetMgr.getLocalIndex(e[t].seatindex);
                this.seatComs[n].setInfo(e[t]),
                this.seatComs[n].setReady(e[t].ready)
            }
        },
        showOthersPaiBei: function(e) {
            var t = cc.vv.gameNetMgr.getLocalSeats()[cc.vv.gameNetMgr.getLocalIndex(e)],
            a = "seat" + t,
        ...
        setResultData: function(e) {
            ...
            var c = function(e, t) {
                var a = cc.vv.gameNetMgr.getLocalSeats();
                this.hideAllTypeName(t.TSPResult);
                for (var n = t.userInfo,
                i = 0; i < n.length; i++) {
                    var s = n[i].userId,
                    o = n[i].score,
                    r = cc.vv.gameNetMgr.getSeatIndexByID(s),
                    c = a[cc.vv.gameNetMgr.getLocalIndex(r)];
        ...
        hideAllTypeName: function(e) {
            for (var t = [], a = 0; a < e.length; a++) {
                var n = cc.vv.gameNetMgr.getSeatIndexByID(e[a].userId);
                t.push(n)
            }
            for (var i = 0; i < cc.vv.gameNetMgr.maxplayer; i++) {
                cc.vv.gameNetMgr.getLocalSeats()[cc.vv.gameNetMgr.getLocalIndex(i)];
        ...
        setAllScoreResult: function(e) {
            ...
            a = 0; a < t; a++) {
                var n = e[a].userId,
                i = cc.vv.gameNetMgr.getSeatIndexByID(n),
        ...
        showTSPResultEx: function(e, t) {
            if (t && !(t.length < 1)) for (var a = 0; a < t.length; a++) {
                ...
                i = t[a].userId,
                s = t[a].type,
                o = cc.vv.gameNetMgr.getSeatIndexByID(i),
                r = {};
                r.holds = n,
                r.type = s,
                r.index = o;
        ...
        showTSPResult: function(e, t) {
            if (t && !(t.length < 1)) for (var a = 0; a < t.length; a++) {
                ...
                var g = cc.vv.gameNetMgr.getSeatIndexByID(i);
            ...
            if (t.shootInfo && !(t.shootInfo.length < 1)) {
                ...
                for (var n in a) {
                    ...
                    if (t.swatUserId != i) for (var s = a[n], o = 0; o < s.length; o++) {
                        var r = s[o],
                        c = cc.vv.gameNetMgr.getSeatIndexByID(i),
                        h = cc.vv.gameNetMgr.getLocalIndex(c),
                        l = cc.vv.gameNetMgr.getSeatIndexByID(r),
                        d = cc.vv.gameNetMgr.getLocalIndex(l),
                        u = {};
                        u.index0 = h,
                        u.index1 = d;
                        var g = function(e, t) { ! t.index1 && t.index1 > cc.vv.gameNetMgr.maxplayer || !t.index0 && t.index0 > cc.vv.gameNetMgr.maxplayer || this.showShoot(t.index0, t.index1)
                        }.bind(this);
                ...
                var v = function(e, t) {
                    for (var a = cc.vv.gameNetMgr.getLocalSeats(), n = 0; n < t.length; n++) {
                        var i = t[n].userId,
                        s = t[n].score,
                        o = cc.vv.gameNetMgr.getSeatIndexByID(i),
                        r = a[cc.vv.gameNetMgr.getLocalIndex(o)];
                        this.setAllScore(r, s, 2)
                    }
                }.bind(this);
                if (e.push(cc.delayTime(1)), e.push(cc.callFunc(v, this.node, t.shootScore)), t.swatUserId > 0) {
                    var f = function(e, a) {
                        var n = cc.vv.gameNetMgr.seats,
                        i = cc.vv.gameNetMgr.getLocalSeats();
                        cc.vv.audioMgr.playSFX("game/sssMusic/quanleda.mp3");
                        for (var s = 0; s < n.length; s++) {
                            var o = n[s].userid;
                            if (0 != o && !(cc.vv.gameNetMgr.fapaiusers.length > 0 && -1 == cc.vv.gameNetMgr.fapaiusers.indexOf(o))) {
                                var r = i[cc.vv.gameNetMgr.getLocalIndex(s)],
                                c = "seat" + r;
                                if (o == t.swatUserId) {
                        ...
                        cc.vv.audioMgr.playSFX("game/sssMusic/Common/jiqiang.mp3")
                    }.bind(this);
                    e.push(cc.delayTime(1)),
        ...
        showTSPCompareResult: function(e, t, a, n) {
            if (! (t.length < 1 || a.length < 1 || n.length < 1)) {
                for (var i = cc.vv.gameNetMgr.getLocalSeats(), s = 0; s < t.length; s++) {
                    var o = {},
                    r = 0,
                    c = 0;
                    if (t[s]) {
                        r = t[s].userId;
                        var h = t[s].arrPai,
                        l = c = cc.vv.gameNetMgr.getSeatIndexByID(r)
                    }
                    var d = "seat" + i[cc.vv.gameNetMgr.getLocalIndex(c)],
                    u = this.getSeatCardNodeByName(d);
                    if (null == u) return;
                    if (u.getChildByName("seatcard").active = !0, u.active = !0, o.comIndex = l, o.arrPai = h, o.comIndex > cc.vv.gameNetMgr.maxplayer) return;
                ...
                for (var g = 0; g < a.length; g++) {
                    ...
                    if (a[g]) {
                        v = a[g].userId;
                        h = a[g].arrPai;
                        f = cc.vv.gameNetMgr.getSeatIndexByID(v)
                    }
                    if (o.comIndex = f, o.arrPai = h, o.comIndex > cc.vv.gameNetMgr.maxplayer) return;
                ...
                for (var p = 0; p < n.length; p++) {
                    ...
                    if (n[p]) {
                        m = n[p].userId;
                        h = n[p].arrPai;
                        _ = cc.vv.gameNetMgr.getSeatIndexByID(m)
                    }
                    if (o.comIndex = _, o.arrPai = h, o.comIndex > cc.vv.gameNetMgr.maxplayer) return;
        ...
        showCompareResult: function(e, t, a, n) {
            if (! (t.length < 1 || a.length < 1 || n.length < 1)) {
                var i = cc.vv.gameNetMgr.getLocalSeats();
                e.push(cc.delayTime(1));
                var s = function(e) {
                    for (var a = 0; a < t.length; a++) {
                        ...
                        if (t[a]) {
                            ...
                            d = o = cc.vv.gameNetMgr.getSeatIndexByID(s)
                        }
                        var u = cc.vv.gameNetMgr.getLocalIndex(o),
                        g = "seat" + i[u],
                        v = this.getSeatCardNodeByName(g);
                        if (null == v) return;
                        if (v.getChildByName("seatcard").active = !0, v.active = !0, n.comIndex = d, n.arrPai = c, n.score = r, n.paiType = l, n.comIndex > cc.vv.gameNetMgr.maxplayer) return;
                ...
                var r = function(t) {
                    for (var a = 0; a < n.length; a++) {
                        ...
                        if (n[a]) {
                            ...
                            u = r = cc.vv.gameNetMgr.getSeatIndexByID(o)
                        }
                        var g = cc.vv.gameNetMgr.getLocalIndex(r),
                        v = "seat" + i[g],
                        f = this.getSeatCardNodeByName(v);
                        if (null == f) return;
                        if (f.getChildByName("seatcard").active = !0, f.active = !0, s.comIndex = u, s.arrPai = h, s.score = c, s.paiType = d, s.comIndex > cc.vv.gameNetMgr.maxplayer) return;
        ...
        showTSPTD: function(e, t) {
            var a = "seat" + cc.vv.gameNetMgr.getLocalSeats()[cc.vv.gameNetMgr.getLocalIndex(e)],
            n = this.getSeatCardNodeByName(a);
            if (null != n) {
                n.active = !0;
                var i = n.getChildByName("seatcard");
        ...
        showTSPZD: function(e, t, a, n) {
            var i = "seat" + cc.vv.gameNetMgr.getLocalSeats()[cc.vv.gameNetMgr.getLocalIndex(e)],
        ...
        showTD: function(e, t, a, n) {
            ...
            var i = cc.vv.gameNetMgr.getLocalSeats()[cc.vv.gameNetMgr.getLocalIndex(e)],
            s = "seat" + i,
        ...
        playSoundByType: function(e) {
            var t = (1 == cc.vv.userMgr.sex ? "game/sssMusic/Male/celltype": "game/sssMusic/Female/celltype") + e + ".mp3";
        ...
        getshuzisprite: function(e) {
            return cc.vv.gameNetMgr.shuzires.getSpriteFrame(e)
        },
        gettexiaosprite: function(e) {
            return cc.vv.gameNetMgr.texiaores.getSpriteFrame(e)
        },
        ...
        showShoot: function(e, t) {
            cc.vv.audioMgr.playSFX("game/sssMusic/daqiang.mp3");
            var a = cc.vv.gameNetMgr.getLocalSeats(),
            n = cc.vv.gameNetMgr.getLocalIndex(e),
            i = a[cc.vv.gameNetMgr.getLocalIndexSEx(n)],
            s = cc.vv.gameNetMgr.getLocalIndex(t),
            o = a[cc.vv.gameNetMgr.getLocalIndexSEx(s)],
            r = "seat" + i,
        ...
        hideShoot: function() {
            for (var e = 0; e < cc.vv.gameNetMgr.maxplayer; e++) {
                var t = "seat" + cc.vv.gameNetMgr.getLocalSeats()[cc.vv.gameNetMgr.getLocalIndex(e)],
        ...
        showPaibei: function() {
            if (this._showPai = !0, 0 != this._loadcard) {
                this.cardnode.active = !0;
                cc.vv.gameNetMgr.getLocalSeats();
                for (var e = cc.vv.gameNetMgr.seats,
                t = 0; t < e.length; t++) {
                    var a = e[t].userid;
                    if (0 != a && !(cc.vv.gameNetMgr.fapaiusers.length > 0 && -1 == cc.vv.gameNetMgr.fapaiusers.indexOf(a))) {
                        var n = cc.vv.gameNetMgr.getSeatIndexByID(a),
                        i = cc.vv.gameNetMgr.getLocalIndex(n);
                        if (console.log("showPaibei   i == " + t + "  uid=  " + a + "  iid=  " + n + "  localIndex==  " + i), a == cc.vv.userMgr.userId) continue;
        ...
        usersPeiPai: function(e) {
            ...
            for (var n = 0; n < a.length; n++) if (0 != a[n].userId && a[n].userId == cc.vv.userMgr.userId && 0 == a[n].isChuPai) return;
            if (console.log("usersPeiPai ---------1--"), this._peipaidata = e, this._showPeiPai = !0, 0 != this._loadcard) {
                console.log("usersPeiPai ---------3--");
                for (var i = 0; i < a.length; i++) if (a[i].userId == cc.vv.userMgr.userId) if (3 == cc.vv.gameNetMgr.myComebackCardData.length) {
                    if (this.showMyPai(cc.vv.gameNetMgr.myComebackCardData), a[i].userId == t) {
                        var s = cc.vv.gameNetMgr.getSeatIndexByID(a[i].userId);
                        this.showSpecialResult(s, null, cc.vv.gameNetMgr.specialType)
                    }
                } else if (0 == this.mySelfPai.length) {
                    var o = cc.vv.gameNetMgr.myHandCard.specialData;
                    if (o.length > 0) {
                        if (this.showMyPai(o), a[i].userId == t) {
                            s = cc.vv.gameNetMgr.getSeatIndexByID(a[i].userId);
                            this.showSpecialResult(s, null, cc.vv.gameNetMgr.myHandCard.type)
                        }
                    } else {
                        for (var r = cc.vv.gameNetMgr.myHandCard.holds,
        ...
        showOthersPeiPai: function(e, t) {
            var a = cc.vv.gameNetMgr.getLocalSeats(),
            n = cc.vv.gameNetMgr.getSeatIndexByID(e),
            i = a[cc.vv.gameNetMgr.getLocalIndex(n)],
            s = "seat" + i,
            o = this.getSeatCardNodeByName(s);
            if (null != o) {
                var r = o.getChildByName("seatcard");
        ...
        HidePeiPaiZi: function() {
            this.cardnode.active = !0;
            for (var e = cc.vv.gameNetMgr.seats,
            t = cc.vv.gameNetMgr.getLocalSeats(), a = 0; a < e.length; a++) {
                var n = e[a].userid;
                if (0 != n && !(cc.vv.gameNetMgr.fapaiusers.length > 0 && -1 == cc.vv.gameNetMgr.fapaiusers.indexOf(n))) {
                    console.log("HidePeiPaiZi == ==========uid =" + n);
                    var i = cc.vv.gameNetMgr.getSeatIndexByID(n),
                    s = "seat" + t[cc.vv.gameNetMgr.getLocalIndex(i)],
                    o = this.getSeatCardNodeByName(s);
                    if (null != o) {
